...
マギアサークルおよびコトダマギアで参照する第三者ライブラリ・モデルの出典です。実際の配布時は、各プロジェクトの指定するライセンス全文と著作権表示を配布物に含めます。
...
- GloVe word vectors — Source: https://github.com/stanfordnlp/GloVe — Apache License 2.0
- fflate — Source: https://github.com/101arrowz/fflate — MIT License
- profanity-list — Source: https://github.com/dsojevic/profanity-list — MIT License
- dictionary-word-list / SCOWL — Source: https://github.com/nlile/dictionary-word-list — SCOWL Copyright and License Agreement
- english_words — Source: https://github.com/filiph/english_words — MIT License
- humannames — Source: https://github.com/FinNLP/humannames — MIT License
- Natural Earth populated places — Source: https://github.com/nvkelso/natural-earth-vector — Public Domain
- GeoNames cities500 — Source: https://www.geonames.org/ — Creative Commons Attribution 4.0 License
